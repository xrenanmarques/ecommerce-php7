                ...
                <div class="col-md-3 col-sm-6">
                    <div class="footer-about-us">
                        ...
                        <div class="footer-social">
                            <a href="https://github.com/xrenanmarques" target="_blank"><i class="fa fa-github"></i></a>
                            <a href="www.linkedin.com/in/xrenanmarques" target="_blank"><i class="fa fa-linkedin"></i></a>
                        </div>
                    </div>
                </div>
    ...
    <div class="footer-bottom-area">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <div class="copyright">
                        <p>&copy; 2019 Renan Marques. <a href="https://github.com/xrenanmarques" target="_blank">GitHub</a></p>
                    </div>
                </div>
